"""
16X2 LCD interfacing with Raspberry Pi in 4 bit parallel mode


This python program will display text on 16x2 lcd 

Python version : Python3
Tested on : Raspberry pi 3B+ and Raspberry pi Zero W
Author : Bahubali Fuladi
Date : 20/01/2022 1:38AM
""" 
#!/usr/bin/env python
